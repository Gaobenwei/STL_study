...
#ifndef STL_STUDY_FUNCTIONAL_H
#define STL_STUDY_FUNCTIONAL_H
...
{
    // 定义一元函数的参数型别和返回值型别
    template<typename Arg,class Result>
    ...
    template<class T>
    struct negate:unarg_function<T,T>
    {
