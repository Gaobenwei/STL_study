...
#ifndef STL_STUDY_STACK_H
#define STL_STUDY_STACK_H
...
namespace mystl
{
    ...
    public:
        ...
        stack(IIter ifrst,IIter last):c_(ifrst,last){}
        ...
        // 修改容器相关操作
        template<class ...Args>
        void emplace(Args&& ...args)  // 以构造元素的方式插入元素
        {
    ...
    // 重载比较操作符 chatgpt解释不一定需要重载operator==，因为stack的底层容器已经重载了
